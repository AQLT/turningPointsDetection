...
all_tp <- merge(readRDS("results/compile_tp/troughs_lp.RDS"),
                readRDS("results/compile_tp/peaks_lp.RDS"),
                by=c("series","kernel", "method"))
all_rev_fe <- select_series(readRDS("results/compile_revisions/lp_fe_rev.RDS"))
all_rev_ce <- select_series(readRDS("results/compile_revisions/lp_ce_rev.RDS"))
all_tp <- select_var(all_tp)

all_tp_rkhs <- select_var(
  merge(readRDS("results/compile_tp/troughs_rkhs.RDS"),
        readRDS("results/compile_tp/peaks_rkhs.RDS"),
        by=c("series","kernel", "method"))
)
all_tp_rkhs <- rbind(all_tp_rkhs,all_tp %>% filter(kernel == "henderson",method=="ql"))
all_rev_rkhs_fe <- select_series(readRDS("results/compile_revisions/rkhs_fe_rev.RDS"))
all_rev_rkhs_ce <- select_series(readRDS("results/compile_revisions/rkhs_ce_rev.RDS"))
