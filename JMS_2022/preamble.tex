...
\line(1,0){450}
\vspace{5mm}
\textbf{{\huge E}\Large M ou EMEX : un paradigme pour le projet OCTOPUSSE}
\end{center}

\begin{center}
\textit{Alain QUARTIER-LA-TENTE} \\
\vspace{2mm}
\textit{(*) Insee, Direction de la méthodologie et de la coordination statistique et internationale}\\ 
...
\vspace{5mm}
\small{{\bf Mots-cl\'es.} (6 maximum) : Échantillonnage, calage, collecte, équilibrage, multimode, séries temporelles.}

\vspace{5mm}
\small{{\bf Domaines.} Utiliser la nomenclature jointe (1 ou 2 domaines ou sous-domaines).}
