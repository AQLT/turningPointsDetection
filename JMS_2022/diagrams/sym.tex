...
%% gray thomson
\draw[edgegeneral] (graythompson.south |- 52, 52 |- theoriegen.north)--(graythompson.south) node[midway, right]{
...
%% guggemos
\draw[edgegeneral] (guggemostitle.north |- 52,  52|-  theoriegen.south)--(guggemostitle.north) node[near start, right]{
