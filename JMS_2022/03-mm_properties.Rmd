...
Tous les indicateurs de qualité sont résumés implémentés dans la fonction `rjdfilters::diagnostic_matrix` sont résumés dans le tableau \@ref(tab:QC). 
Ils proviennent en majorité de critères définis par @ch15HBSA et @trilemmaWMR2019 pour construire les filtres asymétriques.
